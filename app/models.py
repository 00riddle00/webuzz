...
class Role(db.Model):
    """Role grants permissions and defines actions for users.
...
class User(UserMixin, db.Model):
    ...
    A user can have at most one role.
    """
    ...
    default_gravatar = db.Column(db.String(16))
    # ----------------------------------
    ...
    def gravatar(self, size=100, rating="g"):
        ...
        return f"{url}/{hash}?s={size}&d={self.default_gravatar}&r={rating}"
...
class Post(db.Model):
    """A post is represented by a body for writing post's text.
...
class Comment(db.Model):
    """A comment is represented by a body for writing comment's text.
